                                ...
                                <div class="customer-form__fieldset-last-name">
                                    ...
                                    <select name="flower_type" id="selectBox"
                                        ...
                                        <option value="Preserved Flower"
                                            ...
                                            {{ $product->flower_type == 'Preserved Flower' ? 'selected' : '' }}>
                                        ...
                                        <option value="Fresh Flower"
                                            ...
                                            {{ $product->flower_type == 'Fresh Flower' ? 'selected' : '' }}>
   ...
   @php
                            ...
                            function showFileInputs() {
                                ...
                                <div class="customer-form__fieldset-last-name">
                                    ...
                                    <label class="customer-form__fieldset-label" for="SKU">Product Name</label>
