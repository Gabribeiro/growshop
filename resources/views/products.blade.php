<x-layout>
                        ...
                        <div class="collection-page__filter-wrapper"><!-- start collection-facets.liquid (SNIPPET) -->
                                            ...
                                            <fieldset class="collection-facets__item-fieldset">
                                                ...
                                                <div class="collection-facets__item-box-wrapper">
                                                    ...
                                                    <div class="collection-facets__sliders-control">
                                                        ...
                                                        <input type="range" id="slider-1" step="1" min="1" max="999" value="1">
                                                        <input type="range" id="slider-2" step="1" min="1" max="999" value="999">
                                                    </div>
                                                    ...
                                                    <label class="collection-facets__item-box">
                                                        ...
                                                        <input id="minPrice" type="number" min="1" value="1"
                                                    ...
                                                    <label class="collection-facets__item-box">
                                                        ...
                                                        <input id="maxPrice" type="number" value="999"
                                    ...
                                    <details open
                                        ...
                                        <div class="collection-facets__item-values">
                                            ...
                                            <fieldset class="collection-facets__item-fieldset item-fieldset--color">
                                                ...
                                                <button id="showAllColour" class="collection-facets__item-button" onclick="document.querySelectorAll('#colorBox').forEach(checkbox => checkbox.checked = false); location.reload();">
                                                    Show All Colours
                                                </button>
                            ...
                            <style scope>
                                ...
                                .range-slider-track {
                                    ...
                                    background: linear-gradient(to right, #E3E3E3 0%, #A3A3A3 0%, #A3A3A3 75%, #E3E3E3 100%);
    ...
    // Ajuste do minGap para garantir uma diferença mínima de 1
    let minGap = 1;
  
    let sliderTrack = document.querySelector(".range-slider-track");
    let sliderMaxValue = 999; // O valor máximo agora é 999
  
    function slideOne() {
      // Garante que a diferença mínima entre os sliders seja respeitada
      ...
      // Atualiza o valor de minPrice (inputMin)
      inputMin.value = inputSliderOne.value;
  
      // Atualiza a cor de fundo da faixa do slider
      fillColor();
    }
    ...
    function slideTwo() {
      ...
      // Atualiza o valor de maxPrice (inputMax)
      inputMax.value = inputSliderTwo.value;
    ...
    function fillColor() {
      // Ajuste para garantir que a porcentagem dos sliders seja calculada corretamente
      let percent1 = (inputSliderOne.value / sliderMaxValue) * 100;
      let percent2 = (inputSliderTwo.value / sliderMaxValue) * 100;
  
      // Garante que a cor de fundo preencha a linha completamente até 100%
      if (percent2 > 100) percent2 = 100;  // Evita que a barra ultrapasse 100%
  
      // Aplica o gradiente de cor à faixa do slider
      sliderTrack.style.background = `linear-gradient(to right, #E3E3E3 ${percent1}% , #A3A3A3 ${percent1}% , #A3A3A3 ${percent2}%, #E3E3E3 ${percent2}%)`;
    }
  
    // Atualiza os valores ao movimentar os sliders
    ...
    inputSliderTwo.addEventListener("input", slideTwo);
                                    ...
                                    <div class="collection-page__loading-more-wrapper">
                                        ...
                                        <div class="loading-more__progress-wrapper">
                                            ...
                                            <style type="text/css">
                                                ...
                                                .product-grid-item-image img:first-child {
                                                    display: block;
                                                }
                                                }
                                            </style>
            ...
            <div id="shopify-section-template--16192518488223__91f5d349-2980-4863-bcdc-b6650a50f5e3"
                ...
                <script type="lazyload_int">
                    ...
                    // Ajuste o minGap de acordo com o novo intervalo de 1 a 999
                    let minGap = 1;  // A diferença mínima deve ser de pelo menos 1 (se você preferir mais margem, altere esse valor)
                  
                    let sliderTrack = document.querySelector(".range-slider-track");
                    let sliderMaxValue = 999; // Máximo agora é 999
                  
                    function slideOne() {
                      if (parseInt(inputSliderTwo.value) - parseInt(inputSliderOne.value) <= minGap) {
                        inputSliderOne.value = parseInt(inputSliderTwo.value) - minGap;
                      }
                      inputMin.value = inputSliderOne.value; // Agora não há necessidade de dividir por 100
                      fillColor();
                    }
                    ...
                    function slideTwo() {
                      ...
                      inputMax.value = inputSliderTwo.value; // Agora não há necessidade de dividir por 100
                      fillColor();
                    }
