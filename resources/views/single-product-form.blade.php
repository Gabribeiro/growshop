            ...
            <script>
                ...
                for (let i = 0; i < colorss.length; i++) {
                    ...
                    colorss[i].addEventListener('click', function(e) {
                        ...
                        $('.product-slider-featured').slick('slickGoTo', i+1);
        ...
        <div class="">
            ...
            <div class="d-flex mb-3">
                ...
                <input id="quantityInput" class="quantity text-center mx-2 fw-bold" name="quantity"
                    ...
                    style="width: 40px; height: 40px; border: 2px solid black;" step="1" value="1" type="number">
...
@if($product->quantity > 1)
            ...
            <button type="submit" class=" cart-icon btn btn-add-tocart " id="AddToCarts">
                ...
                <div class="text-btn">
                    ...
                    <span class="btn-money">
                        ...
                        <span>AU$<span id="singlePrice">{{ $product->price }}</span> </span></span>
        ...
        {{-- <button 
                                            ...
                                            data-product-url="https://.com/products/another-year-of-love-acrylic-round-box-1-preserved-stem">
...
<button type="button" disabled class="btn btn-add-tocart"><span
