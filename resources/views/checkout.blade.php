<x-checkout-portal>
        ...
        <div class="f1jux fc8Jc kZBua mB_Id _1fragemps _1fragempo _1fragemw8">
                                        ...
                                        <div>
                                            ...
                                            <div class="_1ip0g651 _1fragemo1 _1fragem4l _1fragem6y _1fragem3c">
                                                ...
                                                <header
                                                    ...
                                                    <span><a class="header__logo-wrapper" title="Potiguara Grow"
            ...
            <div class="U6oc4 yesOe">
                ...
                <button aria-pressed="false" aria-controls="disclosure_details" aria-expanded="false"
                    class="b20QW"><span class="IfmSL">
                        ...
                        <span>
                            ...
                            <div class="_1ip0g651 _1fragemo1 _1fragem5z _1fragem8c _1fragem3c _1fragemr7">

                                <p translate="no"
                                    class="_1x52f9s1 _1fragemo1 _1x52f9sz _1fragemqe _1x52f9s3 _1x52f9so notranslate">

                                    {{ env('PAYMENT_CURRENCY_SYMBOL') }}{{ session('total_price') }}
                                </p>
                ...
                <div id="disclosure_details" hidden=""
                    class="_94sxtb1 _1fragemuo _1fragemuq _1fragemo1 _1fragemvv _1fragemvl" style="height: 0px;">
                    ...
                    <div class="ETRXz">
                        ...
                        <main id="checkout-main" class="jvQbN">
                            ...
                            <div class="_1ip0g651 _1fragemo1 _1fragem5z _1fragem4r _1fragem8c _1fragem74 _1fragem3c">
                                ...
                                <form action="/cart/checkout/{{ $order->id }}/pay-by-stripe" method="POST">
                                                                                ...
                                                                                <div id="shippingAddressForm">
                                                                                    ...
                                                                                    <div aria-hidden="false"
                                                                                        ...
                                                                                        <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <input
                                                                                                                ...
                                                                                                                required
                                                                                                                @if (Session::has('adresses')) value="{{ Session('adresses')['firstName'] }}" @endif
                                                                                                                type="text"
                                                                                                                aria-required="true"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <input
                                                                                                                ...
                                                                                                                required
                                                                                                                @if (Session::has('adresses')) value="{{ Session('adresses')['lastName'] }}" @endif
                                                                                                                type="text"
                                                                                                                aria-required="true"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <input
                                                                                                                ...
                                                                                                                type="text"
                                                                                                                @if (Session::has('adresses')) value="{{ Session('adresses')['company'] }}" @endif
                                                                                                                aria-required="false"
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <input
                                                                                                                            ...
                                                                                                                            placeholder="Address"
                                                                                                                            required
                                                                                                                            @if (Session::has('adresses')) value="{{ Session('adresses')['address1'] }}" @endif
                                                                                                                            type="text"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <input
                                                                                                                ...
                                                                                                                type="text"
                                                                                                                @if (Session::has('adresses')) value="{{ Session('adresses')['address2'] }}" @endif
                                                                                                                aria-required="false"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <input
                                                                                                                ...
                                                                                                                required
                                                                                                                type="tel"
                                                                                                                @if (Session::has('adresses')) value="{{ Session('adresses')['phone'] }}" @endif
                                                                                                                aria-required="true"
                                                                                            ...
                                                                                            <div class="_1fragemo1 _1fragem4g _1fragem6t _1fragem3c _1fragemol _1fragemoh _16s97g7f _16s97g7p _16s97g71j _16s97g71t w3_bg"
                                                                                                style="--_16s97g7a: minmax(0, 1fr); --_16s97g7k: minmax(auto, max-content); --_16s97g71e: minmax(0, 1fr); --_16s97g71o: minmax(auto, max-content);">

                                                                                                <div
                                                                                                    class="_7ozb2u2 _1fragem3w _1fragem69 _1fragemo1 _1fragem3c _10vrn9p1 _10vrn9p0 _10vrn9p4 _1fragempt w3_bg">

                                                                                                    <div
                                                                                                        class="_1fragemo1 w3_bg">
                                                                                                        ...
                                                                                                        <label
                                                                                                            ...
                                                                                                            class="cektnc3 _1fragemnr _1fragemvb _1fragemuu _1fragemw2 _1fragemvp _1fragemvk _1fragemvy _1fragemvz"><span
                                                                                                                class="cektnc9"><span
                                                                                                                    class="rermvf1 _1fragemuo _1fragemuq _1fragem2i">Email</span></span></label>

                                                                                                        <div
                                                                                                            class="_7ozb2u6 _1fragemo1 _1fragem3c _1fragemq3 _1fragemvp _1fragemvk _1fragemvy _1fragemw1 _1fragempt _1fragemw8 _7ozb2ul _7ozb2uh w3_bg">
                                                                                                            ...
                                                                                                            <input
                                                                                                                ...
                                                                                                                aria-labelledby="TextField3-label"
                                                                                                                autocomplete="shipping address-line2"
                                                                                                                @if (Session::has('adresses')) value="{{ Session('adresses')['email'] }}" @endif
                                                                                                                class="_7ozb2uq _1fragemo1 _1fragemw2 _1fragemqz _1fragemva _7ozb2ur _7ozb2u11 _7ozb2u1h">
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <input
                                                                                                                ...
                                                                                                                placeholder="City"
                                                                                                                required
                                                                                                                @if (Session::has('adresses')) value="{{ Session('adresses')['city'] }}" @endif
                                                                                                                type="text"
                                                                                                                aria-required="true"
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <select
                                                                                                                ...
                                                                                                                <option
                                                                                                                    ...
                                                                                                                    value="{{ $state }}"
                                                                                                                    @if (Session::has('adresses')) @if (Session('adresses')['state']==$state) selected @endif
                                                                                                                    @endif>
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <label
                                                                                                                ...
                                                                                                                class="cektnc3 _1fragemnr _1fragemvb _1fragemuu _1fragemw2 _1fragemvp _1fragemvk _1fragemvy _1fragemvz"><span
                                                                                                                    ...
                                                                                                                    <span
                                                                                                                        class="rermvf1 _1fragemuo _1fragemuq _1fragem2i">Post
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <input
                                                                                                                    ...
                                                                                                                    required
                                                                                                                    @if (Session::has('adresses')) value="{{ Session('adresses')['postalCode'] }}" @endif
                                                                                                                    type="text"
                                                                                                                    inputmode="text"
                                                                                                                    aria-required="true"
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <fieldset id="delivery_strategies">
                                                                            ...
                                                                            <div
                                                                                style="margin-top: 20px;font-weight: 900;">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                @if ($allFlowerTypes === ['Preserved Flower'])
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="_1fragemo1">
                                                                                            ...
                                                                                            <input
                                                                                                ...
                                                                                                type="radio"
                                                                                                value="express"
                                                                                                onclick="checkout_calculate_shipping()"
                                                                                                id="delivery-express"
                                                                                                required
                                                                                                @if (Session::has('adresses')) @if (Session('adresses')['delivery_strategies']=='express' )
                                                                                                checked @endif
                                                                                                @endif
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div class="_1fragemo1">
                                                                                            ...
                                                                                            <input
                                                                                                ...
                                                                                                onclick="checkout_calculate_shipping()"
                                                                                                value="standard"
                                                                                                @if (Session::has('adresses')) @if (Session('adresses')['delivery_strategies']=='standard' )
                                                                                                checked @endif
                                                                                                @else checked
                                                                                                @endif
                                                                                ...
                                                                                @elseif(in_array('Fresh Flower', $allFlowerTypes))
                                                                                <div>
                                                                                ...
                                                                                <div role="cell" class="_1x41w3p8">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <abbr translate="no"
                                                                                                class="_19gi7yt0 _19gi7ytq _1fragemqb _19gi7yti notranslate _19gi7yt14 _1fragemvg">AUD</abbr><strong
                                                                                                translate="no"
                                    ...
                                    <p style="color:red;"> Please calculate shipping price to enable the button</p>
                                    @endif
                                    ...
                                    <button class="btn btn-success w-100"
                                        style="height: 60px; font-size: 22px;
                                                        ...
                                                        border-radius: 10px;"
                                        @if (session('shipping_cost')=='' ) disabled @endif id="checkout-pay-button"
                                        type="submit">
                                    ...
                                    <div class="_1ip0g651 _1fragemo1 _1fragem4q _1fragem73 _1fragem3c">
                                        ...
                                        <div class="_1ip0g651 _1fragemo1 _1fragem4q _1fragem73 _1fragem3c">
                                            ...
                                            <section class="_1fragem2i _1fragemo1">
                                                ...
                                                <div class="_1fragemvc">
                                                    ...
                                                    <h4 id="ResourceList0" class="n8k95w1 _1fragemo1 n8k95w5">Shopping
                                                ...
                                                <div role="table" aria-labelledby="ResourceList0"
                                                    ...
                                                    <div role="row"
                                                        ...
                                                        <div role="cell"
                                                            ...
                                                            <div class="_1m6j2n32 _1fragemo1 _1fragemwc _1m6j2n33"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div style="background: red; border: 3px solid red;"
                                                        ...
                                                        <div role="cell"
                                                            ...
                                                            <div class="_1fragem2i _1fragemo1 iZ894">

                                                                <p
                                                                    class="_1x52f9s1 _1fragemo1 _1x52f9sv _1fragemqc">

                                                                    {{ $item['name'] == 'Try Before Buy' ? $item['sku'] : $item['name'] }}
                                                                ...
                                                                <div
                                                                    ...
                                                                    @if ($item['print_type'])
                                                                    <span>Add Personalized
                                                                        {{ $item['print_type'] }} in your Roses:
                                                                    </span>
                                                                    @endif
                                                                    ...
                                                                    <picture style="height: 50px;">
                                                                        ...
                                                                        <source media="(min-width: 0px)"
                                                                            srcset="/storage/personalizeImages/{{ $item['print_image'] }}">

                                                                        <img src="/storage/personalizeImages/{{ $item['print_image'] }}"
                                                                            alt="picture"
                                                                            style="height:30px;"
                                                                            class="_1h3po424 _1fragem2i _1fragemn2 _1fragemrl _1fragemrq _1fragems0 _1fragemrv _1fragem9q _1fragem96 _1fragemaa _1fragem8m _1fragemc3 _1fragembe _1fragemcs _1fragemap _1fragemnh">
                                                        ...
                                                        <div role="cell" class="_6zbcq53s _1fragem2s _1fragemq5 _1fragemr1 _6zbcq53q">

                                                            <div class="_1fragemvc"><span class="_19gi7yt0 _19gi7yts _1fragemqc">1<span
                                                                        aria-hidden="true" class="_19gi7yt0 _19gi7yts _1fragemqc">

                                                                        x</span></span></div>

                                                        </div>

                                                        <div role="cell" class="_6zbcq53s _1fragem2s _1fragemq5 _1fragemr4">
                                        ...
                                        <div class="_1ip0g651 _1fragemo1 _1fragem4q _1fragem73 _1fragem3c">
                                            ...
                                            <section class="_1fragem2i _1fragemo1">
                                                ...
                                                <div class="_1ip0g651 _1fragemo1 _1fragem4g _1fragem6t _1fragem3c">
                                                    ...
                                                    <div class="_1fragem2n" id="discount_form">
                                                        ...
                                                        <div class="_1fragemo1">
                                                            ...
                                                            <div class="_1fragemo1 _1fragem3c _1fragem3w _1fragem6t _1fragemol _16s97g7f _16s97g7p _16s97g71j _16s97g71t"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="_1fragemo1">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <input style="border: 2px solid black;" id="discountCodeBox"
                                                                                name="reductions" placeholder="Discount code"
                                                                                value="{{ $discount_code ? $discount_code : '' }}"
                                                                                type="text" {{ $discount_value ? 'disabled' : '' }}
                                                                ...
                                                                <button onClick="return discount_form()"
                                                                    style="background: white; color: black;" type="submit"
                                        ...
                                        <script type="text/javascript">
                                            function discount_form() {
                                                ...
                                                if (code == '') {
                                                    ...
                                                    @endif
                                                    var getv = $('#postal-code').val();
                                                    var delivery_strategies = $("input[name='delivery_strategies']:checked").val(),
                                                        postalCode = getv,
                                                        state = $('#state-box').find(":selected").val();
                                            ...
                                            /*
                                                                                                     ...
                                                                                                     var getv = $('#postal-code').val();
                                                                                                            const link = `${window.location.origin}/getDiscount{{ $order->id }}`;    
                                                                                                                    ...
                                                                                                                    postalCode =  getv,
                                                                                                                    state =  $('#state-box').find(":selected").val();
                                                                                                            axios.post(link, {reductions: code, 
                                                                                                                    'postalCode':postalCode,
                                                                                                                    'delivery_strategies':delivery_strategies,
                                                                                                                    'state':state,
                                                                                                                        'firstName': $('input[name="firstName"]').val(),
                                        ...
                                        <section class="_1fragem2i _1fragemo1">
                                            ...
                                            <div class="_1fragemvc">
                                                ...
                                                <h4 id="MoneyLine-Heading0" class="n8k95w1 _1fragemo1 n8k95w5">Cost
                                            ...
                                            <div role="table" aria-labelledby="MoneyLine-Heading0" class="nfgb6p0">
                                                ...
                                                <div role="row" class="_1qy6ue61 _1fragem3c _1qy6ue65">
                                                    ...
                                                    <div role="cell" class="_1qy6ue68">
                                                        @if (session('shipping_cost'))
                                                        <span translate="no" id="shipping-total"
                                                            class="_19gi7yt0 _19gi7yts _1fragemqc 

                                                                        _19gi7ytm _19gi7yti notranslate Shipping-colsval">
                                                            {{ env('PAYMENT_CURRENCY_SYMBOL') }}
                                                            <span class="Shipping-cols">{{ session('shipping_cost') }}</span>
                                                        </span>
                                                        @else
                                                        <button onclick="checkout_calculate_shipping()" id="checkout-calculate-shipping">
                                                ...
                                                <div role="row" class="_1x41w3p1 _1fragem3c _1fragemou _1x41w3p5">
                                                    ...
                                                    <div role="cell" class="_1x41w3p8">
                                                        ...
                                                        <div class="_1fragemo1 _1fragem2s _1fragemr4">
                                                            ...
                                                            <div
                                                                ...
                                                                <abbr translate="no"
                                                                    class="_19gi7yt0 _19gi7ytq _1fragemqb _19gi7yti notranslate _19gi7yt14 _1fragemvg"></abbr>

                                                                <strong translate="no"
                                                                    class="_19gi7yt0 _19gi7yty _1fragemqf _19gi7yt2 notranslate">

                                                                    <span id="full-price">{{ env('PAYMENT_CURRENCY_SYMBOL') }}
                                                                        {{ $full_price ? round(session('full_price'), 2) : round(session('total_price'), 2) }}</span>
    ...
    <script type="text/javascript">
        $("#postal-code, #state-box").on("keyup change", function(e) {
            var getv = $('#postal-code').val();
            if (getv.length > 3) {

                checkout_calculate_shipping();
            }
        });

        function checkout_calculate_shipping() {

            var getv = $('#postal-code').val();

            if (getv.length < 4 && getv == '') {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    // $('.Shipping-cols').html(result);
                    //$('.Shipping-colsval').show();
                    window.location.replace("/cart/checkout/{{ $order->id }}");
                }
            });
