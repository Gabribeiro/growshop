        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link @if(request()->routeIs('grow.home')) active @endif" href="{{ route('grow.home') }}">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if(request()->routeIs('grow.products')) active @endif" href="{{ route('grow.products') }}">Produtos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if(request()->routeIs('grow.builder')) active @endif" href="{{ route('grow.builder') }}">Monte seu Grow</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if(request()->routeIs('grow.about')) active @endif" href="{{ route('grow.about') }}">Sobre Nós</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if(request()->routeIs('grow.contact')) active @endif" href="{{ route('grow.contact') }}">Contato</a>
                    </li>
                </ul>
                <div class="d-flex align-items-center">
                    <a href="{{ route('grow.cart') }}" class="btn btn-custom-outline me-2">
                        <i class="bi bi-cart"></i> Carrinho
                        @if(session()->has('cart') && count(session()->get('cart')) > 0)
                            <span class="badge bg-primary text-white ms-1">{{ count(session()->get('cart')) }}</span>
                        @endif
                    </a>
                    @if(auth()->check())
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="userMenuDropdown">
                                ...
                                <li><a class="dropdown-item" href="{{ route('grow.orders') }}"><i class="bi bi-bag me-2"></i>Pedidos</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="{{ route('grow.about') }}"><i class="bi bi-chevron-right me-2"></i> Sobre nós</a></li>
                        <li class="mb-2"><a href="{{ route('grow.contact') }}"><i class="bi bi-chevron-right me-2"></i> Contato</a></li>
                        <li class="mb-2"><a href="{{ route('grow.products') }}"><i class="bi bi-chevron-right me-2"></i> Produtos</a></li>
