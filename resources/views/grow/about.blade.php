    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="about-section">
                ...
                <p>Fundada em 2020, a {{ config('app.name') }} nasceu da visão de redesenhar móveis funcionais que integrassem perfeitamente tecnologia e discrição. Nossa equipe de designers e engenheiros especializados criou soluções que combinam estética sofisticada e funcionalidade prática.</p>
        ...
        <div class="col-lg-4">
            <div class="about-section">
                ...
                <div class="text-center mt-4">
                    <img src="{{ asset('img/logo.png') }}" alt="Logo {{ config('app.name') }}" class="img-fluid" style="max-width: 200px;">
                </div>
            </div>
        </div>
    </div>
