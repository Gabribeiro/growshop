...
@section('title', 'Gerenciar Endereços - Potiguara Grow Shop')
...
<div class="container py-4">
    <div class="breadcrumbs">
        <ul class="breadcrumbs__list">
            <li class="breadcrumbs__item"><a href="{{ route('grow.home') }}">Home</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="address-section">
                <h2 class="address-title">{{ $firstName . ' ' . $lastName }}</h2>
                        ...
                        <div class="col-12">
                            <div class="card bg-dark border-secondary mb-4">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title">{{ $address->company }}</h5>
                                    <p class="card-text mb-1">{{ $address->address1 }}</p>
                                    @if($address->address2)
                                        <p class="card-text mb-1">{{ $address->address2 }}</p>
                                    @endif
                                    <p class="card-text mb-1">{{ $address->city }}, {{ $address->country }}</p>
                                    @if($address->postal)
                                        <p class="card-text mb-1">CEP: {{ $address->postal }}</p>
                                    @endif
                                    <p class="card-text">Telefone: {{ $address->phone }}</p>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        @if(!$address->default)
                                            <form action="/conta/enderecos/{{ auth()->user()->id }}/{{ $address->id }}" method="POST" class="d-inline ms-2">
                                                @csrf
                                                @method('DELETE')
                            ...
                            <div id="edit-form" style="display: none;">
                                <form action="/conta/enderecos/{{ auth()->user()->id }}/{{ $address->id }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="company" id="company" class="form-control" value="{{ $address->company }}" required>
                                        </div>
                                        <div class="col-md-6 form-group">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="address1" id="address1" class="form-control" value="{{ $address->address1 }}" required>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label for="address2" class="form-label">Complemento</label>
                                            <input type="text" name="address2" id="address2" class="form-control" value="{{ $address->address2 }}">
                                        </div>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" name="postal" id="postal" class="form-control" value="{{ $address->postal }}">
                                        </div>
                                        
                                        <div class="col-12 checkbox-default">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="default" id="default" value="1" {{ $address->default ? 'checked' : '' }}>
                ...
                <div id="new-address-form" {{ isset($address) && $address ? 'style=display:none;' : '' }}>
                    <h3 class="mb-4">Adicionar Novo Endereço</h3>
                    
                    <form action="/conta/enderecos/{{ auth()->user()->id }}" method="POST">
                        @csrf
