        ...
        <div class="col-lg-7">
            <div class="register-section">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="firstName" name="firstName" placeholder="Digite seu nome" value="{{ old('firstName') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Digite seu sobrenome" value="{{ old('lastName') }}" required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="login-link">
                    Já tem uma conta? <a href="{{ route('grow.login') }}">Faça login</a>
                </div>
            </div>
        </div>
