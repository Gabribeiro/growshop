 ...
 ">
                        ...
                        <div class="products-info">
                            ...
                            <div class="product-half half-img product-slider-sticky">
                              ...
                              <source src="/storage/products/{{ $product->product_image }}" type="video/mp4">
                                              Your browser does not support HTML video.
                                                ...
                                                <img width="600" height="600"
                                                    ...
                                                    alt="{{ $product->product_image }}" class="slick-img"

                                                    data-magnify-src="/storage/products/{{ $product->product_image }}"
                            ...
                            <div class="product-half"><!-- start product-tabs-accordion.liquid (SNIPPET) -->
                                ...
                                <section class="tabs-section" data-section-type="product-tabs">
                                    ...
                                    <div class="tabs-accordion">
                                        ...
                                        @if ($product->flower_type == 'Preserved Flower')
