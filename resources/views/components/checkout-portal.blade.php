...
<head>
    ...
    <title>Checkout - Potiguara Grow</title>
    ...
    <style scoped>
            ...
            --select-icon: url(//.com/cdn/shop/t/12/assets/icon-arrow-down_30x.png?v=126378520099475741281695383956);
...
<body class="template-index">
                        ...
                        <div class="info">
                            ...
                            <div class="info__container">
                                <div class="info__contact"><a title="E-mail" class="footer__business-info-email"
                                        id="ftr-info-mail" href="mailto:contato@potiguaragrow.com.br"
                                        target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                            ...
                                            <path
                                                ...
                                                stroke-linejoin="round" />
                                        </svg><span>contato@potiguaragrow.com.br</span>
                                    </a></div>
                        ...
                        <div class="credits desktop">
                            <div class="wrapper">
                                <p class="copyright-class" id="copyright" style="font-size: 14px; color: #767676;">
                                    An Official Licensee of Potiguara Grow.
                                </p>
 ...
 return false;
    ...
    <script type="lazyload_int"
    data-src="//.com/cdn/shop/t/12/assets/VastaShop.js?v=157113441304378571361696948568"></script>
    <script src="{{ asset('js/local-shopify.js') }}"></script>
    <script src="{{ asset('js/local-shop.js') }}"></script>
    ...
    <script type="lazyload_int"
    data-src="//.com/cdn/shop/t/12/assets/jquery.tmpl.min.js?v=32513529418586026101695383958"></script>
    <script type="lazyload_int"
    data-src="//.com/cdn/shop/t/12/assets/jquery.products.min.js?v=24328245287809131551695383962"></script>
    <script
    <script
    ...
    <script type="lazyload_int"
    data-src="//.com/cdn/shop/t/12/assets/priority-processing.js?v=95274878743863531891695921677"></script>
