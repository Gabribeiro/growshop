...
<div class="container py-5">
    <?php if(isset($cart) && $cart && count($cart) > 0): ?>
        <div class="row">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="<?php echo e(route('grow.cart.update')); ?>" method="POST" class="d-flex align-items-center">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="product_id" value="<?php echo e($item['id']); ?>">
                                            <input type="number" name="quantity" value="<?php echo e($item['quantity']); ?>" min="1" class="form-control quantity-selector me-2">
                                            <button type="submit" class="btn btn-sm btn-update-cart"><i class="bi bi-arrow-repeat"></i></button>
                                        </form>
                                    </td>
                                    <td>R$ <?php echo e(number_format($subtotal, 2, ',', '.')); ?></td>
                                    <td>
                                        <form action="<?php echo e(route('grow.cart.remove')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <input type="hidden" name="product_id" value="<?php echo e($item['id']); ?>">
            ...
            <div class="col-lg-4">
                <div class="cart-summary">
                    ...
                    <div class="d-flex justify-content-between mb-4 pt-3 border-top" style="border-color: var(--card-border) !important;">
                        ...
                        <span class="fw-bold text-success">R$ <?php echo e(number_format($total, 2, ',', '.')); ?></span>
                    </div>
                    <div class="d-grid gap-2">
                        <a href="<?php echo e(route('grow.checkout')); ?>" class="btn btn-custom-primary">Finalizar Compra</a>
                        <a href="<?php echo e(route('grow.products')); ?>" class="btn btn-outline-secondary">Continuar Comprando</a>
                    </div>
                    <div class="mt-4">
    ...
    <?php else: ?>
        <div class="empty-cart">
            ...
            <a href="<?php echo e(route('grow.products')); ?>" class="btn btn-custom-primary">Ver Produtos</a>
        </div>
    <?php endif; ?>
</div>
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('grow.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/grow/cart.blade.php ENDPATH**/ ?>