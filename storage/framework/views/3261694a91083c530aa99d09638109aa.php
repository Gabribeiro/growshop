            ...
            <div class="order-confirmation-container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 order-lg-2 mb-4">
                        <div class="card bg-dark border-secondary mb-4">
                            <div class="card-body">
                                ...
                                <div class="order-summary-item">
                                    <span>Subtotal:</span>
                                    <span>R$ <?php echo e(number_format($order->total_price, 2, ',', '.')); ?></span>
                                </div>
                        ...
                        <div class="shipping-address mb-4">
                            ...
                            <p class="mb-1"><?php echo e($address['name']); ?></p>
                            <p class="mb-1"><?php echo e($address['address']); ?></p>
                            <?php if(isset($address['complement']) && $address['complement']): ?>
                                <p class="mb-1"><?php echo e($address['complement']); ?></p>
                            <?php endif; ?>
                            <p class="mb-1">
                                <?php echo e($address['city']); ?> - <?php echo e($address['state']); ?>

                            </p>
                            <p class="mb-0">CEP: <?php echo e($address['postalCode']); ?></p>
                        </div>
                        ...
                        <div class="note-box">
                            ...
                            <p class="mb-0">
                                ...
                                <?php else: ?>
                                    Forma de pagamento: <?php echo e($order->payment_method); ?>
                                            ...
                                            <tr class="border-bottom border-secondary">
                                                <td>
                                                    <?php if($product->image): ?>
                                                        <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="img-fluid rounded" style="max-width: 60px; max-height: 60px; object-fit: cover;">
                                                    <?php else: ?>
                                                ...
                                                <td class="text-white">
                                                    <h6 class="mb-1 text-white"><?php echo e($product->name); ?></h6>
                                                    <?php if($product->pivot->color): ?>
                                                        <small class="text-light">Cor: <?php echo e($product->pivot->color); ?></small>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-center align-middle text-white"><?php echo e($product->pivot->quantity); ?></td>
                                                <td class="text-end align-middle fw-bold text-white">R$ <?php echo e(number_format($subtotal, 2, ',', '.')); ?></td>
                                            </tr>
                ...
                <div class="text-center mt-5">
                    <div class="action-buttons justify-content-center">
                        ...
                        <?php if(Auth::check()): ?>
                        <a href="<?php echo e(route('grow.orders')); ?>" class="btn btn-outline-success">
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('grow.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/grow/order-confirmation.blade.php ENDPATH**/ ?>