<aside id="CartDrawer" class="cart-drawer__box">
    ...
    <div class="cart-drawer__header">
        ...
        <h2 class="cart-drawer__title">
            ...
            <?php if(session('total_quantity') > 0): ?>
                ...
                <div id="CartItemsForm">
                    ...
                    <form class="cart-items__form" action="/cart/checkout" method="POST">
                        ...
                        <ul class="cart-items__list">
                            ...
                            <?php $__currentLoopData = session()->get('products'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                            <li class="cart-items__line-item " data-key=<?php echo e($item['id']); ?>>
                                ...
                                <span class="cart-items__item-image-wrapper">
                                    ...
                                    <img id="761028815" class="responsive-image cart-items__item-image"
                                        ...
                                        src="/storage/products/<?php echo e($item['image']); ?>"
                                ...
                                <div class="cart-items__item-info-wrapper">
                                            ...
                                            <div class="cart-items__info-names">
                                                ...
                                                <h2 class="cart-items__item-title">
                                                    ...
                                                    <a href="/products/<?php echo e($item['id']); ?>"
                                                        ...
                                                        title="<?php echo e($item['name']); ?>"><?php echo e($item['name'] == "Try Before Buy" ? $item['sku'] : $item['name']); ?> </a>
                                                ...
                                                <span> <?php echo e($item['flower_type']); ?> Flower </span> <br>
                                                <?php if($item['print_type']): ?>
                                                <span>Personalized <?php echo e($item['print_type']); ?>:</span> <br>
                                                <?php endif; ?>

                                                <span>
                                                    <?php if($item['print_text']): ?>
                                                    "<?php echo e($item['print_text']); ?>"</span> <br>
                                                <?php endif; ?>
                                                <?php if($item['print_font']): ?>
                                                <span><?php echo e($item['print_font']); ?>

                                                    <?php endif; ?>
                                                    <?php if($item['print_color']): ?>
                                                    - <?php echo e(ucfirst($item['print_color'])); ?></span>
                                    ...
                                    <span class="cart-items__item-result">
                                        ...
                                        <a href="/cart/remove?<?php echo e(http_build_query($item)); ?>" class="cart-items__item-remove">
                                        ...
                                        <span class="cart-items__item-price">
                                            ...
                                            <?php echo e(env('PAYMENT_CURRENCY_SYMBOL')); ?><span class="product-money"><?php echo e($item['price']); ?></span></span>
                        ...
                        <div class="cart__total-price-wrapper">
                            ...
                            <span class="cart__total-price">
                                ...
                                <?php if(session()->get('total_price')): ?>

                                <?php echo e(env('PAYMENT_CURRENCY_SYMBOL')); ?><span class="subtotal-money"><?php echo e(session('total_price')); ?></span>
                        ...
                        <button
                            ...
                            <?php if(session()->has('total_quantity')): ?>

                            <span class="cart__item-count">

                                (<?php echo e(session('total_quantity')); ?>
...
</aside><?php /**PATH /var/www/resources/views/cart-item-only.blade.php ENDPATH**/ ?>