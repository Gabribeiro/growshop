         ...
         <div id="NavDrawer" class="sidenav sidenav--drawer-left " data-section-type="menu-mobile">
             ...
             <div class="sidenav__main">
                 <ul id="main-menu" class="sidenav__list list--parent">
                                     ...
                                     <?php $__currentLoopData = $types->pluck('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <li class="sidenav__list__item">
                                             <a class="sidenav__item__anchor " id="mobile-menu-2--1"
                                                 href="/collections/type/<?php echo e(str_replace(' ', '-', strtolower($type))); ?>">
                                                 <?php echo e($type); ?>
                             ...
                             <li class="sidenav__list__item item--submenu">
                                 ...
                                 <ul class="sidenav__list list--grandchild">
                                     <?php $__currentLoopData = $shapes->pluck('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shape): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <li class="sidenav__list__item">
                                             <a class="sidenav__item__anchor " id="mobile-menu-2--1"
                                                 href="/collections/type/<?php echo e(str_replace(' ', '-', strtolower($shape))); ?>">
                                                 <?php echo e($shape); ?>
                             ...
                             <li class="sidenav__list__item item--submenu">
                                 ...
                                 <ul class="sidenav__list list--grandchild">
                                     <?php $__currentLoopData = $sizes->pluck('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <li class="sidenav__list__item">
                                             <a class="sidenav__item__anchor " id="mobile-menu-2--1"
                                                 href="/collections/type/<?php echo e(str_replace(' ', '-', strtolower($size))); ?>">
                                                 <?php echo e($size); ?>
                             ...
                             <li class="sidenav__list__item item--submenu">
                                 ...
                                 <ul class="sidenav__list list--grandchild">
                                     <?php $__currentLoopData = $materials->pluck('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <li class="sidenav__list__item">
                                             <a class="sidenav__item__anchor " id="mobile-menu-2--1"
                                                 href="/collections/type/<?php echo e(str_replace(' ', '-', strtolower($material))); ?>">
                                                 <?php echo e($material); ?>
                     ...
                     <li class="sidenav__list__item item--submenu">
                         <div class="sidenav__item">
                             <a id="mobile-menu-1" class="sidenav__item__anchor " href="/pages/design-your-own">TRY BEFORE
                                 BUY
                             </a>
                         </div>
                     </li>
                     ...
                     <li class="sidenav__list__item item--submenu">
                         ...
                         <ul class="sidenav__list list--child">
                             <li class="sidenav__list__item item--submenu">
                                 ...
                                 <ul class="sidenav__list list--grandchild">
                                     <?php $__currentLoopData = $everyday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                         <li class="sidenav__list__item">
                                             <a class="sidenav__item__anchor " id="mobile-menu-3--1"
                                                 href="/collections/event/<?php echo e(strtolower($event->name)); ?>">
                 ...
                 <ul id="shop-info" class="sidenav__list sidenav__list--shop">
                     <li class="sidenav__list__item">
                         <a id="mobile-menu-email" class="sidenav__item__anchor "
                             href="mailto:contato@potiguaragrow.com.br?Subject=Hello%20again" target="_top"><svg
...
<?php /**PATH /var/www/resources/views/menu-mobile.blade.php ENDPATH**/ ?>