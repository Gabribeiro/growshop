            ...
            <div class="customer-form__wrapper">
                <div class="customer-register-form__wrapper wrapper" id="CustomerLoginForm">
                    ...
                    <div class="customer-form__title-wrapper">
                        <h1 class="customer-form__title">Create <?php if(session()->has('isAdmin')): ?>
                                Sub-Admin
                            <?php endif; ?> Account</h1>
                        <p class="customer-form__sub-title">Register <?php if(session()->has('isAdmin')): ?>
                                Sub-Admin
                            <?php else: ?>
                                your
                            <?php endif; ?>
                    ...
                    <form method="post"
                        <?php if(session()->has('isAdmin')): ?> action="/admin/users/register"
                        <?php else: ?>
                        action="/account/register" <?php endif; ?>
