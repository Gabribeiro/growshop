                        ...
                        <div class="customer-form__logo-wrapper">
                            <a href="/"
                                ...
                                <img id="244132823" class="responsive-image"
                                    src="//.com/cdn/shop/files/Favicon.svg?v=1700829289&width=50"
                                    srcset="//.com/cdn/shop/files/Favicon.svg?v=1700829289&width=100 100w,//.com/cdn/shop/files/Favicon.svg?v=1700829289&width=153 153w,//.com/cdn/shop/files/Favicon.svg?v=1700829289&width=234 234w,//.com/cdn/shop/files/Favicon.svg?v=1700829289&width=358 358w,//.com/cdn/shop/files/Favicon.svg?v=1700829289&width=548 548w,"
 ...
 $('account__logout-modal-wrapper').toggleClass('logout-modal--open');
                    ...
                    <div class="address__container">
                            ...
                            <div class="address__content">
                                <div class="address__content-container">
                                    <div class="address__content-headline">
                                        <h5 class="account__address-name"> <?php echo e($firstName . ' ' . $lastName); ?> </h5>
                                ...
                                <div id="AddressEditForm" class="hide address__edit-form">
                                    <form method="post"
                                        action="/account/addresses/<?php echo e(auth()->user()->id); ?>/<?php echo e($address->id); ?>"
                                        ...
                                        <div class="address__edit-form-fieldset-wrapper">
                                            ...
                                            <div class="address__edit-form-fieldset">
                                                ...
                                                <input type="text" name="company" id="AddressCompany"
                                                    class="customer-form__input" value="<?php echo e($address->company); ?>"
                                            ...
                                            <div class="address__edit-form-fieldset">
                                                ...
                                                <input type="text" name="address1" id="AddressAddress1"
                                                    class="customer-form__input" value="<?php echo e($address->address1); ?>"
                                                    autocapitalize="words">
                                            </div>
                                            ...
                                            <div class="address__edit-form-fieldset">
                                                ...
                                                <input type="text" name="address2" id="AddressAddress2"
                                                    class="customer-form__input" value="<?php echo e($address->address2); ?>"
                                                    autocapitalize="words">
                                            </div>
                                            ...
                                            <div class="address__edit-form-fieldset">
                                                ...
                                                <input type="text" name="city" id="AddressCity"
                                                    class="customer-form__input" value="<?php echo e($address->city); ?>"
                                                    autocapitalize="words">
                                            </div>
                                            ...
                                            <div class="address__edit-form-fieldset">
                                                ...
                                                <input type="text" name="postal" id="AddressZip"
                                                    class="customer-form__input" value="<?php echo e($address->postal); ?>"
                                            ...
                                            <div class="address__edit-form-fieldset">
                                                ...
                                                <input type="tel" name="phone" id="AddressPhone"
                                                    class="customer-form__input" value="<?php echo e($address->phone); ?>"
                                                    pattern="[0-9\-]*">
                                            </div>
                        ...
                        <div id="AddressNewForm" class="hide address__add-new-form">
                            <form method="post" action="/account/addresses/<?php echo e(auth()->user()->id); ?>"
...
<?php endif; ?>
<?php /**PATH /var/www/resources/views/address.blade.php ENDPATH**/ ?>