...
<section class="featured-products py-5">
    <div class="container">
        ...
        <div class="text-center mt-4">
            <a href="<?php echo e(route('grow.products')); ?>" class="btn btn-custom-primary">VER TODOS OS PRODUTOS</a>
        </div>
    </div>
</section>
    ...
    <div class="container promo-content">
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <a href="<?php echo e(route('grow.products')); ?>" class="btn btn-custom-primary mt-3">APROVEITAR AGORA</a>
            </div>
                ...
                <div class="category-card">
                    ...
                    <div class="category-overlay">
                        <div>
                            ...
                            <p class="category-text"><?php echo e(Str::limit($category->description, 80)); ?></p>
                            <a href="<?php echo e(route('grow.products', ['category' => $category->id])); ?>" class="btn btn-custom-outline btn-sm">Ver Produtos</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('grow.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/grow/home.blade.php ENDPATH**/ ?>