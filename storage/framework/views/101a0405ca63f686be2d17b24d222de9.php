...
<div class="container py-5">
    <form action="<?php echo e(route('grow.cart')); ?>" method="POST" id="checkout-form">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-lg-8">
            ...
            <div class="col-lg-4">
                <div class="order-summary">
                    ...
                    <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="order-item">
                            <div>
                                ...
                                <small class="d-block text-muted">Quantidade: <?php echo e($item['quantity']); ?></small>
                            </div>
                    ...
                    <div class="d-grid gap-2 mt-4">
                        ...
                        <a href="<?php echo e(route('grow.cart')); ?>" class="btn btn-outline-secondary">Voltar ao Carrinho</a>
                    </div>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('grow.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/grow/checkout.blade.php ENDPATH**/ ?>