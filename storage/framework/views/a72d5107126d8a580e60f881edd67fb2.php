                                        ...
                                        <tr>
                                            ...
                                            <td><button
                                               ...
                                               border-radius: 5px; font-size: 22px;">
                                                   ...
                                                   <?php echo e($order->is_delivered ? 'Delivered' : 'To be Delivered'); ?>
                        ...
                        <div class="account__address-wrapper"><!-- start snippets/customer-address.liquid -->
                            ...
                            <div class="account__customer-addresses-link">
                                ...
                                <a class="account__customer-addresses" title="Addresses" id="id-addresses"
                                    ...
                                    href="/account/addresses/<?php echo e(auth()->user()->id); ?>">View Addresses (1)
...
<?php /**PATH /var/www/resources/views/account.blade.php ENDPATH**/ ?>