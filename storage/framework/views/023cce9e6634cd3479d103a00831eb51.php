    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-2">
                <li class="breadcrumb-item"><a href="<?php echo e(route('grow.home')); ?>">Home</a></li>
                <li class="breadcrumb-item"><a href="<?php echo e(route('grow.products')); ?>">Produtos</a></li>
    ...
    <div class="row">
        <div class="col-lg-6 mb-4">
            <div class="product-image-container">
                <?php if($product->image): ?>
                    <img src="<?php echo e('/storage/'.$product->image); ?>" class="img-fluid" alt="<?php echo e($product->name); ?>">
                <?php else: ?>
        ...
        <div class="col-lg-6">
            <div class="product-details">
                ...
                <p class="product-price mb-3">R$ <?php echo e(number_format($product->price, 2, ',', '.')); ?></p>
                <div class="mb-4">
                    <p class="mb-3"><?php echo e($product->description); ?></p>
                    
                    <ul class="product-features mt-4">
                        <?php if(isset($product->type) && $product->type && is_object($product->type)): ?>
                            <li><i class="bi bi-check-circle"></i> <strong>Categoria:</strong> <?php echo e($product->type->name); ?></li>
                        <?php elseif(isset($product->type) && $product->type): ?>
                            <li><i class="bi bi-check-circle"></i> <strong>Categoria:</strong> <?php echo e($product->type); ?></li>
                        <?php endif; ?>
                ...
                <form action="<?php echo e(route('grow.cart.add')); ?>" method="POST" class="mt-4">
                    <?php echo csrf_field(); ?>
        ...
        <div class="col-12">
            ...
            <div class="tab-content product-tab-content" id="productTabsContent">
                <div class="tab-pane fade show active" id="details" role="tabpanel" aria-labelledby="details-tab">
                    ...
                    <p>Nosso <?php echo e(strtolower($product->name)); ?> é projetado com os mais altos padrões de qualidade e discrição, oferecendo uma solução ideal para cultivadores que valorizam tanto a funcionalidade quanto a estética.</p>
                ...
                <div class="tab-pane fade" id="installation" role="tabpanel" aria-labelledby="installation-tab">
                    ...
                    <p>A instalação do seu <?php echo e(strtolower($product->name)); ?> é simples e pode ser realizada seguindo as etapas abaixo:</p>
                ...
                <div class="tab-pane fade" id="maintenance" role="tabpanel" aria-labelledby="maintenance-tab">
                    ...
                    <p>Para garantir o funcionamento ideal e a longevidade do seu <?php echo e(strtolower($product->name)); ?>, recomendamos seguir estas diretrizes de manutenção:</p>
                    ...
                    <div class="card product-card h-100">
                        <div class="card-img-container">
                            <?php if($relatedProduct->image): ?>
                                <img src="<?php echo e('/storage/'.$relatedProduct->image); ?>" class="card-img-top" alt="<?php echo e($relatedProduct->name); ?>">
                            <?php else: ?>
                                <div class="d-flex justify-content-center align-items-center w-100 h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text text-muted mb-3"><?php echo e(\Str::limit($relatedProduct->description, 60)); ?></p>
                            <div class="mt-auto">
                                <p class="card-text fw-bold">R$ <?php echo e(number_format($relatedProduct->price, 2, ',', '.')); ?></p>
                                <a href="<?php echo e(route('grow.product.detail', $relatedProduct->id)); ?>" class="btn btn-custom-primary w-100">Ver Detalhes</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('grow.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/grow/product-detail.blade.php ENDPATH**/ ?>